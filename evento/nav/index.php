                ...
                <div class="slider-content-inner">
                    <div class="container">
                        <div class="slider-content-center">
                            ...
                            <strong class="cover-xl-text">evento</strong>
                            <p class="cover-date">
                                Todo lo que estas buscando a un click.
                            </p>
            ...
            <div class="slider_content">
                <div class="slider-content-inner">
                    <div class="container">
                        <div class="slider-content-center">
                            <h2 class="cover-title">
                                Joao Vitor & Ernestina
                            </h2>
                            <strong class="cover-xl-text">Casamiento</strong>
                            <p class="cover-date">
                                09-18 Marzo 2019  - Rivera, Uruguay.
                            </p>    
                            <a href="#" class=" btn btn-primary btn-rounded" >
                                Confirmar!
                            </a>
                ...
                <div class="slider-content-inner">
                    <div class="container">
                        <div class="slider-content-center">
                            ...
                            <strong class="cover-xl-text">Casamiento</strong>
                            <p class="cover-date">
                                12-14 Febrero 2019  - Santana do Livramento - RS
                            </p>
                            <a href="#" class=" btn btn-primary btn-rounded" >
                                Confirmar Presencia!    
                            </a>
